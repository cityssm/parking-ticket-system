...
const createParkingBylaws = (parkingDB) => {
...
const createParkingOffences = (parkingDB) => {
...
const createParkingTickets = (parkingDB) => {
...
const createParkingTicketRemarks = (parkingDB) => {
...
const createParkingTicketStatusLog = (parkingDB) => {
...
const createLicencePlateLookupBatches = (parkingDB) => {
...
const createLicencePlateLookupBatchEntries = (parkingDB) => {
...
const createParkingTicketConvictionBatches = (parkingDB) => {
...
const createLicencePlateOwners = (parkingDB) => {
...
const createLicencePlateLookupErrorLog = (parkingDB) => {
