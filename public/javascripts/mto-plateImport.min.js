(function(){document.getElementById("mtoImport--importFile").addEventListener("change",function(a){var b=document.getElementById("mtoImport--importFileName"),c=document.getElementById("mtoImport--importFileMessage");0<a.currentTarget.files.length&&(a=a.currentTarget.files[0].name,b.innerText=a,/^\d+[.]txt$/igm.test(a)?cityssm.clearElement(c):c.innerHTML='<div class="tag is-warning"><span class="icon"><i class="fas fa-exclamation-triangle" aria-hidden="true"></i></span><span>MTO file names are generally a number with a ".txt" extension.</span></div>')});
