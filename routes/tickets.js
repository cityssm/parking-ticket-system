...
router.post('/doAcknowledgeLookupError', permissionHandlers.updatePostHandler, handler_doAcknowledgeLookupError);
router.post('/doReconcileAsMatch', permissionHandlers.updatePostHandler, handler_doReconcileAsMatch);
router.post('/doReconcileAsError', permissionHandlers.updatePostHandler, handler_doReconcileAsError);
router.post('/doQuickReconcileMatches', permissionHandlers.updatePostHandler, handler_doQuickReconcileMatches);
router.post('/doGetRecentConvictionBatches', permissionHandlers.updateOrOperatorPostHandler, handler_doGetRecentConvictionBatches);
router.post('/doGetConvictionBatch', permissionHandlers.updateOrOperatorPostHandler, handler_doGetConvictionBatch);
router.post('/doCreateConvictionBatch', permissionHandlers.updatePostHandler, handler_doCreateConvictionBatch);
router.post('/doAddTicketToConvictionBatch', permissionHandlers.updatePostHandler, handler_doAddTicketToConvictionBatch);
router.post('/doLockConvictionBatch', permissionHandlers.updatePostHandler, handler_doLockConvictionBatch);
router.post('/doUnlockConvictionBatch', permissionHandlers.updatePostHandler, handler_doUnlockConvictionBatch);
router.get(['/new', '/new/:ticketNumber'], permissionHandlers.updateGetHandler, handler_new);
router.post('/doCreateTicket', permissionHandlers.updatePostHandler, handler_doCreateTicket);
router.post('/doUpdateTicket', permissionHandlers.updatePostHandler, handler_doUpdateTicket);
router.post('/doDeleteTicket', permissionHandlers.updatePostHandler, handler_doDeleteTicket);
router.post('/doResolveTicket', permissionHandlers.updatePostHandler, handler_doResolveTicket);
router.post('/doUnresolveTicket', permissionHandlers.updatePostHandler, handler_doUnresolveTicket);
router.post('/doRestoreTicket', permissionHandlers.updatePostHandler, handler_doRestoreTicket);
router.post('/doGetRemarks', handler_doGetRemarks);
router.post('/doAddRemark', permissionHandlers.updatePostHandler, handler_doAddRemark);
router.post('/doUpdateRemark', permissionHandlers.updatePostHandler, handler_doUpdateRemark);
router.post('/doDeleteRemark', permissionHandlers.updatePostHandler, handler_doDeleteRemark);
router.post('/doGetStatuses', handler_doGetStatuses);
router.post('/doAddStatus', permissionHandlers.updatePostHandler, handler_doAddStatus);
router.post('/doUpdateStatus', permissionHandlers.updatePostHandler, handler_doUpdateStatus);
router.post('/doDeleteStatus', permissionHandlers.updatePostHandler, handler_doDeleteStatus);
...
router.get('/convict/:batchId/print', permissionHandlers.updateOrOperatorGetHandler, handler_convictPrint);
router.post('/doMarkConvictionBatchSent', permissionHandlers.updateOrOperatorGetHandler, handler_doMarkConvictionBatchSent);
