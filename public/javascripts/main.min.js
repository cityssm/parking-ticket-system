...
(function(){function a(a){var c=document.createElement("div");c.className="modal is-active";var b=a.contextualColorName||"info",d=a.titleString||"",e=a.bodyHTML||"",f=a.cancelButtomHTML||"Cancel";c.innerHTML='<div class="modal-background"></div><div class="modal-content"><div class="message is-'+b+'"><header class="message-header"><span></span></header>'+('<section class="message-body">'+(""===e?"":'<div class="has-margin-bottom-10">'+e+"</div>")+('<div class="buttons justify-flex-end">'+(a.hideCancelButton?
