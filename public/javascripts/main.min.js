...
function(c,e){var f={provinceShortName:e,color:"#000",backgroundColor:"#fff"};if(!b)return{licencePlateCountryAlias:c,licencePlateProvinceAlias:e,licencePlateProvince:f};var h=a.licencePlateCountryAliases[c.toUpperCase()]||c,d=e;a.licencePlateProvinceAliases.hasOwnProperty(h)&&(d=a.licencePlateProvinceAliases[h][e.toUpperCase()]||e);var g=f;a.licencePlateProvinces.hasOwnProperty(h)&&(g=a.licencePlateProvinces[h].provinces[d]||f);return{licencePlateCountryAlias:h,licencePlateProvinceAlias:d,licencePlateProvince:g}};
var g={},d=!1;pts.getTicketStatus=function(c){var e={statusKey:c,status:c};if(!b)return e;if(!d){for(var f=0;f<a.parkingTicketStatuses.length;f+=1){var h=a.parkingTicketStatuses[f];g[h.statusKey]=h}d=!0}return g[c]||e}})();pts.showModal=function(a){a.classList.add("is-active")};pts.hideModal=function(a){a=a.currentTarget||a;(a.classList.contains("modal")?a:a.closest(".modal")).classList.remove("is-active")};
