...
router.get(["/new", "/new/:ticketNumber"], permissionHanders.createGetHandler, handler_new);
router.post("/doCreateTicket", permissionHanders.createPostHandler, handler_doCreateTicket);
router.post("/doUpdateTicket", permissionHanders.createPostHandler, handler_doUpdateTicket);
router.post("/doDeleteTicket", permissionHanders.createPostHandler, handler_doDeleteTicket);
router.post("/doResolveTicket", permissionHanders.createPostHandler, handler_doResolveTicket);
router.post("/doUnresolveTicket", permissionHanders.createPostHandler, handler_doUnresolveTicket);
...
router.post("/doAddRemark", permissionHanders.createPostHandler, handler_doAddRemark);
router.post("/doUpdateRemark", permissionHanders.createPostHandler, handler_doUpdateRemark);
router.post("/doDeleteRemark", permissionHanders.createPostHandler, handler_doDeleteRemark);
router.post("/doGetStatuses", handler_doGetStatuses);
router.post("/doAddStatus", permissionHanders.createPostHandler, handler_doAddStatus);
router.post("/doUpdateStatus", permissionHanders.createPostHandler, handler_doUpdateStatus);
router.post("/doDeleteStatus", permissionHanders.createPostHandler, handler_doDeleteStatus);
router.get("/:ticketID", handler_view);
router.get("/byTicketNumber/:ticketNumber", handler_byTicketNumber);
router.get("/:ticketID/edit", permissionHanders.createGetHandler, handler_edit);
