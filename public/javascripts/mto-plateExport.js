...
(function () {
    ...
    function fn_populateBatchView(batch) {
        ...
        if (batchIsLocked) {
            ...
            batchEntriesContainerEle.insertAdjacentHTML("beforeend", "<a class=\"button is-fullwidth has-margin-bottom-10\" href=\"https://www.apps.rus.mto.gov.on.ca/edtW/login/login.jsp\" target=\"_blank\" rel=\"noreferrer\">" +
            ...
            onshow: function (modalEle) {
                ...
                if (canUpdate) {
                    ...
                    createBatchButtonEle.addEventListener("click", function () {
                        ...
                        cityssm.confirmModal("Create a New Batch?", "Are you sure you want to create a new licence plate lookup batch?", "Yes, Create a Batch", "info", createFn);
                    });
                }
            },
            onshown: function (_modalEle, closeModalFn) {
    ...
    if (canUpdate) {
        lockBatchButtonEle.addEventListener("click", function () {
            ...
            cityssm.confirmModal("Lock Batch?", "<strong>Are you sure you want to lock the batch?</strong><br />" +
                ...
                " All tickets related to the licence plates in the batch will be updated with a \"Pending Lookup\" status.", "Yes, Lock the Batch", "info", lockFn);
        });
    }
