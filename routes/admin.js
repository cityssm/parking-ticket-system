...
router.get("/userManagement", adminGetHandler, handler_userManagement);
router.post("/doCreateUser", adminPostHandler, handler_doCreateUser);
router.post("/doUpdateUser", adminPostHandler, handler_doUpdateUser);
router.post("/doUpdateUserProperty", adminPostHandler, handler_doUpdateUserProperty);
router.post("/doResetPassword", adminPostHandler, handler_doResetPassword);
router.post("/doGetUserProperties", adminPostHandler, handler_doGetUserProperties);
router.post("/doDeleteUser", adminPostHandler, handler_doDeleteUser);
