...
pts.alertModal("Location Not Added",a.message,"OK","danger")})};cityssm.openHtmlModal("location-add",{onshown:function(a,b){c=b;document.getElementById("addLocation--locationClassKey").insertAdjacentHTML("beforeend",f);document.getElementById("form--addLocation").addEventListener("submit",d)}})})})();
