...
export const getLicencePlateOwnerWithDB = (database, licencePlateCountry, licencePlateProvince, licencePlateNumber, recordDateOrBefore) => {
    ...
    const possibleOwners = database.prepare("select * from LicencePlateOwners" +
    ...
    for (const possibleOwnerObject of possibleOwners) {
        const ownerPlateCountryAlias = configFunctions.getProperty("licencePlateCountryAliases")[possibleOwnerObject.licencePlateCountry] ||
            possibleOwnerObject.licencePlateCountry;
        const ownerPlateProvinceAlias = (configFunctions.getProperty("licencePlateProvinceAliases")[ownerPlateCountryAlias] || {})[possibleOwnerObject.licencePlateProvince] || possibleOwnerObject.licencePlateProvince;
