...
(function(){function a(a){a.preventDefault();a=parseInt(a.currentTarget.getAttribute("data-index"));var c=b[a],e,d=function(){cityssm.postJSON("/admin/doDeleteLocation",{locationKey:c.locationKey},function(a){a.success&&(e(),b=a.locations,g())})},l=function(a){a.preventDefault();cityssm.confirmModal("Delete Location",'Are you sure you want to remove "'+c.locationName+'" from the list of available options?',"Yes, Remove Location","danger",d)},h=function(a){a.preventDefault();cityssm.postJSON("/admin/doUpdateLocation",
a.currentTarget,function(a){a.success&&(e(),b=a.locations,g())})};cityssm.openHtmlModal("location-edit",{onshow:function(){document.getElementById("editLocation--locationKey").value=c.locationKey;var a=document.getElementById("editLocation--locationClassKey");a.innerHTML=f;k.has(c.locationClassKey)||a.insertAdjacentHTML("beforeend",'<option value="'+cityssm.escapeHTML(c.locationClassKey)+'">'+cityssm.escapeHTML(c.locationClassKey)+"</option>");a.value=c.locationClassKey;document.getElementById("editLocation--locationName").value=
c.locationName},onshown:function(a,c){e=c;document.getElementById("form--editLocation").addEventListener("submit",h);a.getElementsByClassName("is-delete-button")[0].addEventListener("click",l)}})}var f="",c=document.getElementById("locationFilter--locationClassKey"),d=document.getElementById("locationFilter--locationName"),h=document.getElementById("locationResults"),k=new Map,g,b=pts.locationsInit;delete pts.locationsInit;g=function(){for(var e=0,f=c.value,g=d.value.trim().toLowerCase().split(" "),
r=document.createElement("tbody"),l=0;l<b.length;l+=1){var m=b[l];if(""===f||f===m.locationClassKey){for(var q=!0,n=m.locationName.toLowerCase(),t=0;t<g.length;t+=1)if(-1===n.indexOf(g[t])){q=!1;break}q&&(e+=1,q=k.has(m.locationClassKey)?k.get(m.locationClassKey).locationClass:m.locationClassKey,n=document.createElement("tr"),n.innerHTML='<td><a data-index="'+l+'" href="#">'+cityssm.escapeHTML(m.locationName)+"</a></td><td>"+cityssm.escapeHTML(q)+"</td>",n.getElementsByTagName("a")[0].addEventListener("click",
a),r.appendChild(n))}}cityssm.clearElement(h);0===e?h.innerHTML='<div class="message is-info"><div class="message-body">There are no locations that meet your search criteria.</div></div>':(h.innerHTML='<table class="table is-fixed is-striped is-hoverable is-fullwidth"><thead><tr><th>Location</th><th>Class</th></tr></thead></table>',h.getElementsByTagName("table")[0].appendChild(r))};c.addEventListener("change",g);d.addEventListener("keyup",g);pts.getDefaultConfigProperty("locationClasses",function(a){c.innerHTML=
'<option value="">(All Location Classes)</option>';for(var b=0;b<a.length;b+=1){var d=a[b];f+='<option value="'+d.locationClassKey+'">'+cityssm.escapeHTML(d.locationClass)+"</option>";k.set(d.locationClassKey,d)}c.insertAdjacentHTML("beforeend",f);g()});document.getElementById("is-add-location-button").addEventListener("click",function(a){a.preventDefault();var c,d=function(a){a.preventDefault();cityssm.postJSON("/admin/doAddLocation",a.currentTarget,function(a){a.success?(c(),b=a.locations,g()):
cityssm.alertModal("Location Not Added",a.message,"OK","danger")})};cityssm.openHtmlModal("location-add",{onshown:function(a,b){c=b;document.getElementById("addLocation--locationClassKey").insertAdjacentHTML("beforeend",f);document.getElementById("form--addLocation").addEventListener("submit",d)}})})})();
