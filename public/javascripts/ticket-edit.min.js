...
'<div class="level"><div class="level-left">'+pts.escapeHTML(e.locationName)+"</div>"+(l?'<div class="level-right"><span class="tag is-primary">'+pts.escapeHTML(l.locationClass)+"</span></div>":"")+"</div>";a.insertAdjacentElement("beforeend",m)}c=document.getElementById("container--parkingLocations");pts.clearElement(c);c.insertAdjacentElement("beforeend",a)})};a=function(a){a.preventDefault();pts.openHtmlModal("ticket-setLocation",{onshown:function(a,b){c=b;g()},onremoved:function(){document.getElementById("is-location-lookup-button").focus()}})};
...
E=function(a){var c=a.currentTarget.getAttribute("data-remark-index");pts.confirmModal("Delete Remark?","Are you sure you want to delete this remark?","Yes, Delete","warning",function(){pts.postJSON("/tickets/doDeleteRemark",{ticketID:b,remarkIndex:c},function(a){a.success&&w()})})},F=function(a){a.preventDefault();var c;a=parseInt(a.currentTarget.getAttribute("data-index"));var e=t[a],d=function(a){a.preventDefault();pts.postJSON("/tickets/doUpdateRemark",a.currentTarget,function(a){a.success&&(c(),
w())})};pts.openHtmlModal("ticket-editRemark",{onshow:function(a){document.getElementById("editRemark--ticketID").value=b;document.getElementById("editRemark--remarkIndex").value=e.remarkIndex;document.getElementById("editRemark--remark").value=e.remark;document.getElementById("editRemark--remarkDateString").value=e.remarkDateString;document.getElementById("editRemark--remarkTimeString").value=e.remarkTimeString;a.getElementsByTagName("form")[0].addEventListener("submit",d)},onshown:function(a,b){c=
...
pts.postJSON("/tickets/doGetRemarks",{ticketID:b},function(a){t=a;A()})};document.getElementById("is-add-remark-button").addEventListener("click",function(a){a.preventDefault();var c,e=function(a){a.preventDefault();pts.postJSON("/tickets/doAddRemark",a.currentTarget,function(a){a.success&&(c(),w())})};pts.openHtmlModal("ticket-addRemark",{onshow:function(a){document.getElementById("addRemark--ticketID").value=b;a.getElementsByTagName("form")[0].addEventListener("submit",e)},onshown:function(a,b){c=
b}})});A()}if(!g){var p=document.getElementById("is-status-panel"),u=pts.ticketStatusLogInit;delete pts.ticketStatusLogInit;var x,G=function(a){a.preventDefault();pts.confirmModal("Mark Ticket as Resolved?","Once resolved, you will no longer be able to make changes to the ticket.","Yes, Resolve Ticket","info",function(){pts.postJSON("/tickets/doResolveTicket",{ticketID:b},function(a){a.success&&(window.location.href="/tickets/"+b)})})},H=function(a){var c=a.currentTarget.getAttribute("data-status-index");
pts.confirmModal("Delete Remark?","Are you sure you want to delete this status?","Yes, Delete","warning",function(){pts.postJSON("/tickets/doDeleteStatus",{ticketID:b,statusIndex:c},function(a){a.success&&x()})})},I=function(a){a.preventDefault();var c;a=parseInt(a.currentTarget.getAttribute("data-index"));var e=u[a],d=function(a){a.preventDefault();pts.postJSON("/tickets/doUpdateStatus",a.currentTarget,function(a){a.success&&(c(),x())})},l=function(a){a=pts.getTicketStatus(a.currentTarget.value);
var b=document.getElementById("editStatus--statusField");b.value="";a&&a.statusField?(b=b.closest(".field"),b.getElementsByTagName("label")[0].innerText=a.statusField.fieldLabel,b.classList.remove("is-hidden")):b.closest(".field").classList.add("is-hidden")};pts.openHtmlModal("ticket-editStatus",{onshow:function(a){document.getElementById("editStatus--ticketID").value=b;document.getElementById("editStatus--statusIndex").value=e.statusIndex;document.getElementById("editStatus--statusField").value=
