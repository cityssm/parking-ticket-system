...
c.value=a.offenceAmount;document.getElementById("ticket--parkingOffence").value=a.bylawDescription;z();q=[]},D=function(){var a=document.getElementById("ticket--locationKey").value;pts.postJSON("/offences/doGetOffencesByLocation",{locationKey:a},function(a){q=a;a=document.createElement("div");a.className="list is-hoverable has-margin-bottom-20";for(var c=0;c<q.length;c+=1){var b=q[c],l=document.createElement("a");l.className="list-item";l.setAttribute("data-index",c);l.setAttribute("href","#");l.addEventListener("click",
C);l.innerHTML='<div class="columns">'+('<div class="column">'+pts.escapeHTML(b.bylawNumber)+"<br /><small>"+pts.escapeHTML(b.bylawDescription)+"</small></div>")+('<div class="column is-narrow">$ '+b.offenceAmount.toFixed(2)+"</div>")+"</div>";a.insertAdjacentElement("beforeend",l)}c=document.getElementById("container--bylawNumbers");pts.clearElement(c);c.appendChild(a)})},h=function(a){a.preventDefault();pts.openHtmlModal("ticket-setBylawOffence",{onshown:function(a,b){z=b;D();document.getElementById("bylawLookup--searchStr").focus()},
onremoved:function(){document.getElementById("is-bylaw-lookup-button").focus()}})};document.getElementById("is-bylaw-lookup-button").addEventListener("click",h);document.getElementById("ticket--bylawNumber").addEventListener("dblclick",h);h=function(){var a=document.getElementById("datalist--licencePlateProvince");pts.clearElement(a);var c=pts.getLicencePlateCountryProperties(document.getElementById("ticket--licencePlateCountry").value);if(c&&c.provinces)for(var c=Object.values(c.provinces),b=0;b<
c.length;b+=1){var d=document.createElement("option");d.setAttribute("value",c[b].provinceShortName);a.appendChild(d)}};document.getElementById("ticket--licencePlateCountry").addEventListener("change",h);pts.loadDefaultConfigProperties(h);var v=function(a){for(a=a.getElementsByClassName("panel-block");0<a.length;)a[0].remove()};if(!g){var r=document.getElementById("is-remark-panel"),t=pts.ticketRemarksInit;delete pts.ticketRemarksInit;var w,E=function(a){var c=a.currentTarget.getAttribute("data-remark-index");
pts.confirmModal("Delete Remark?","Are you sure you want to delete this remark?","Yes, Delete","warning",function(){pts.postJSON("/tickets/doDeleteRemark",{ticketID:b,remarkIndex:c},function(a){a.success&&w()})})},F=function(a){a.preventDefault();var c;a=parseInt(a.currentTarget.getAttribute("data-index"));var e=t[a],d=function(a){a.preventDefault();pts.postJSON("/tickets/doUpdateRemark",a.currentTarget,function(a){a.success&&(c(),w())})};pts.openHtmlModal("ticket-editRemark",{onshow:function(a){document.getElementById("editRemark--ticketID").value=
b;document.getElementById("editRemark--remarkIndex").value=e.remarkIndex;document.getElementById("editRemark--remark").value=e.remark;document.getElementById("editRemark--remarkDateString").value=e.remarkDateString;document.getElementById("editRemark--remarkTimeString").value=e.remarkTimeString;a.getElementsByTagName("form")[0].addEventListener("submit",d)},onshown:function(a,b){c=b}})},A=function(){v(r);if(0===t.length)r.insertAdjacentHTML("beforeend",'<div class="panel-block is-block"><div class="message is-info"><p class="message-body">There are no remarks associated with this ticket.</p></div></div>');
else for(var a=0;a<t.length;a+=1){var c=t[a],b=document.createElement("div");b.className="panel-block is-block";b.innerHTML='<div class="columns">'+('<div class="column"><p class="has-newline-chars">'+pts.escapeHTML(c.remark)+'</p><p class="is-size-7">'+(c.recordCreate_timeMillis===c.recordUpdate_timeMillis?"":'<i class="fas fa-pencil-alt" aria-hidden="true"></i> ')+c.recordUpdate_userName+" - "+c.remarkDateString+" "+c.remarkTimeString+"</p></div>")+(c.canUpdate?'<div class="column is-narrow"><div class="buttons is-right has-addons">'+
...
"</div>";c.canUpdate&&(b.getElementsByClassName("is-edit-remark-button")[0].addEventListener("click",F),b.getElementsByClassName("is-delete-remark-button")[0].addEventListener("click",E));r.appendChild(b)}};w=function(){v(r);r.insertAdjacentHTML("beforeend",'<div class="panel-block is-block"><p class="has-text-centered has-text-grey-lighter"><i class="fas fa-2x fa-circle-notch fa-spin" aria-hidden="true"></i><br /><em>Loading remarks...</p></div>');pts.postJSON("/tickets/doGetRemarks",{ticketID:b},
function(a){t=a;A()})};document.getElementById("is-add-remark-button").addEventListener("click",function(a){a.preventDefault();var c,e=function(a){a.preventDefault();pts.postJSON("/tickets/doAddRemark",a.currentTarget,function(a){a.success&&(c(),w())})};pts.openHtmlModal("ticket-addRemark",{onshow:function(a){document.getElementById("addRemark--ticketID").value=b;a.getElementsByTagName("form")[0].addEventListener("submit",e)},onshown:function(a,b){c=b}})});A()}if(!g){var p=document.getElementById("is-status-panel"),
u=pts.ticketStatusLogInit;delete pts.ticketStatusLogInit;var x,G=function(a){a.preventDefault();pts.confirmModal("Mark Ticket as Resolved?","Once resolved, you will no longer be able to make changes to the ticket.","Yes, Resolve Ticket","info",function(){pts.postJSON("/tickets/doResolveTicket",{ticketID:b},function(a){a.success&&(window.location.href="/tickets/"+b)})})},H=function(a){var c=a.currentTarget.getAttribute("data-status-index");pts.confirmModal("Delete Remark?","Are you sure you want to delete this status?",
"Yes, Delete","warning",function(){pts.postJSON("/tickets/doDeleteStatus",{ticketID:b,statusIndex:c},function(a){a.success&&x()})})},I=function(a){a.preventDefault();var c;a=parseInt(a.currentTarget.getAttribute("data-index"));var e=u[a],d=function(a){a.preventDefault();pts.postJSON("/tickets/doUpdateStatus",a.currentTarget,function(a){a.success&&(c(),x())})},l=function(a){a=pts.getTicketStatus(a.currentTarget.value);var b=document.getElementById("editStatus--statusField");b.value="";a&&a.statusField?
(b=b.closest(".field"),b.getElementsByTagName("label")[0].innerText=a.statusField.fieldLabel,b.classList.remove("is-hidden")):b.closest(".field").classList.add("is-hidden")};pts.openHtmlModal("ticket-editStatus",{onshow:function(a){document.getElementById("editStatus--ticketID").value=b;document.getElementById("editStatus--statusIndex").value=e.statusIndex;document.getElementById("editStatus--statusField").value=e.statusField;document.getElementById("editStatus--statusNote").value=e.statusNote;var c=
document.getElementById("editStatus--statusDateString");c.value=e.statusDateString;c.setAttribute("max",pts.dateToString(new Date));document.getElementById("editStatus--statusTimeString").value=e.statusTimeString;pts.getDefaultConfigProperty("parkingTicketStatuses",function(a){for(var b=!1,c=document.getElementById("editStatus--statusKey"),m=0;m<a.length;m+=1){var d=a[m];if(d.isUserSettable||d.statusKey===e.statusKey)if(c.insertAdjacentHTML("beforeend",'<option value="'+d.statusKey+'">'+d.status+
"</option>"),d.statusKey===e.statusKey&&(b=!0,d.statusField)){var f=document.getElementById("editStatus--statusField").closest(".field");f.getElementsByTagName("label")[0].innerText=d.statusField.fieldLabel;f.classList.remove("is-hidden")}}b||c.insertAdjacentHTML("beforeend",'<option value="'+e.statusKey+'">'+e.statusKey+"</option>");c.value=e.statusKey;c.addEventListener("change",l)});a.getElementsByTagName("form")[0].addEventListener("submit",d)},onshown:function(a,b){c=b}})},B=function(){v(p);
if(0===u.length)p.insertAdjacentHTML("beforeend",'<div class="panel-block is-block"><div class="message is-info"><p class="message-body">There are no statuses associated with this ticket.</p></div></div>');else for(var a=0;a<u.length;a+=1){var b=u[a],e=pts.getTicketStatus(b.statusKey);if(0===a&&e&&e.isFinalStatus){var d=document.createElement("div");d.className="panel-block is-block";d.innerHTML='<div class="message is-info is-clearfix"><div class="message-body"><div class="columns"><div class="column"><strong>This ticket is able to be marked as resolved.</strong></div><div class="column is-narrow has-text-right"><button class="button is-info" type="button"><span class="icon is-small"><i class="fas fa-check" aria-hidden="true"></i></span><span>Resolve Ticket</span></button></div></div></div></div>';
...
pts.postJSON("/tickets/doGetStatuses",{ticketID:b},function(a){u=a;B()})};document.getElementById("is-add-status-button").addEventListener("click",function(a){a.preventDefault();var c,e=function(a){a.preventDefault();var d=document.getElementById("addStatus--resolveTicket").checked;pts.postJSON("/tickets/doAddStatus",a.currentTarget,function(a){a.success&&(c(),d?window.location.href="/tickets/"+b:x())})},d=function(a){a=pts.getTicketStatus(a.currentTarget.value);var b=document.getElementById("addStatus--statusField");
b.value="";a&&a.statusField?(b=b.closest(".field"),b.getElementsByTagName("label")[0].innerText=a.statusField.fieldLabel,b.classList.remove("is-hidden")):b.closest(".field").classList.add("is-hidden");b=document.getElementById("addStatus--resolveTicket");b.checked=!1;a&&a.isFinalStatus?b.closest(".field").classList.remove("is-hidden"):b.closest(".field").classList.add("is-hidden")};pts.openHtmlModal("ticket-addStatus",{onshow:function(a){document.getElementById("addStatus--ticketID").value=b;pts.getDefaultConfigProperty("parkingTicketStatuses",
function(a){for(var b=document.getElementById("addStatus--statusKey"),c=0;c<a.length;c+=1){var e=a[c];e.isUserSettable&&b.insertAdjacentHTML("beforeend",'<option value="'+e.statusKey+'">'+e.status+"</option>")}b.addEventListener("change",d)});a.getElementsByTagName("form")[0].addEventListener("submit",e)},onshown:function(a,b){c=b}})});pts.loadDefaultConfigProperties(B)}for(var h=function(a){a.preventDefault();a=a.currentTarget;var b=a.getAttribute("data-unlock"),b=a.closest(".field").getElementsByTagName(b)[0];
b.removeAttribute("readonly");b.classList.remove("is-readonly");b.focus();a.setAttribute("disabled","disabled")},n=document.getElementsByClassName("is-unlock-field-button"),y=0;y<n.length;y+=1)n[y].addEventListener("click",h)})();
