...
"Yes, Clear the Batch","warning",function(){cityssm.postJSON("/plates/doClearLookupBatch",{batchID:d},function(a){a.success&&(k(a.batch),l())})})}function B(a){a.preventDefault();a=function(){window.open("/plates/mtoExport/"+d);r=!0};r?a():cityssm.confirmModal("Download Batch?","<strong>You are about to download this batch for the first time.</strong><br />The date of this download will be tracked as part of the batch record.","OK, Download the File","warning",a)}function C(a,b){return a+'<a class="tag has-tooltip-bottom" data-tooltip="View Ticket (Opens in New Window)" href="/tickets/byTicketNumber/'+
