...
describe('helpers/mtoFunctions', () => {
  ...
  describe('#sixDigitDateNumberToEightDigit()', () => {
    ...
    const currentDateSixDigits = Number.parseInt(
      currentDateEightDigits.toString().slice(-6),
      10
    )
  ...
  describe('#parsePKRD()', () => {
    describe('valid PKRD string', () => {
      const validString =
        'PKRDSAMPLE    200102TKT123      xxxxxxxxxxxxxxx700101MDOE,JOHN/DOE,JANE                                 1234 FAKE ST,SAULT STE MARIE            A1A1A1CHEV19130000  KMBLK                                   2101                         '
