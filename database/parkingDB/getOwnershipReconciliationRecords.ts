...
export const getOwnershipReconciliationRecords = (): ReconciliationRecord[] => {
  ...
  for (const record of records) {
    record.ticket_issueDateString = dateTimeFns.dateIntegerToString(
    ...
    record.owner_recordDateString = dateTimeFns.dateIntegerToString(
      record.owner_recordDate
    )
    record.owner_licencePlateExpiryDateString = dateTimeFns.dateIntegerToString(
    ...
    record.dateDifference = dateTimeFns.dateStringDifferenceInDays(
      record.ticket_issueDateString,
      record.owner_recordDateString
    )
