...
E=function(a){var c=a.currentTarget.getAttribute("data-remark-index");pts.confirmModal("Delete Remark?","Are you sure you want to delete this remark?","Yes, Delete","warning",function(){cityssm.postJSON("/tickets/doDeleteRemark",{ticketID:b,remarkIndex:c},function(a){a.success&&w()})})},F=function(a){a.preventDefault();var c;a=parseInt(a.currentTarget.getAttribute("data-index"));var e=t[a],d=function(a){a.preventDefault();cityssm.postJSON("/tickets/doUpdateRemark",a.currentTarget,function(a){a.success&&
...
b){c=b}})});A()}if(!g){var p=document.getElementById("is-status-panel"),u=pts.ticketStatusLogInit;delete pts.ticketStatusLogInit;var x,G=function(a){a.preventDefault();pts.confirmModal("Mark Ticket as Resolved?","Once resolved, you will no longer be able to make changes to the ticket.","Yes, Resolve Ticket","info",function(){cityssm.postJSON("/tickets/doResolveTicket",{ticketID:b},function(a){a.success&&(window.location.href="/tickets/"+b)})})},H=function(a){var c=a.currentTarget.getAttribute("data-status-index");
pts.confirmModal("Delete Remark?","Are you sure you want to delete this status?","Yes, Delete","warning",function(){cityssm.postJSON("/tickets/doDeleteStatus",{ticketID:b,statusIndex:c},function(a){a.success&&x()})})},I=function(a){a.preventDefault();var c;a=parseInt(a.currentTarget.getAttribute("data-index"));var e=u[a],d=function(a){a.preventDefault();cityssm.postJSON("/tickets/doUpdateStatus",a.currentTarget,function(a){a.success&&(c(),x())})},l=function(a){a=pts.getTicketStatus(a.currentTarget.value);
