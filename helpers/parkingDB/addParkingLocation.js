...
export const addParkingLocation = (requestBody) => {
    const database = sqlite(databasePath);
    const locationRecord = database.prepare("select locationName, isActive" +
    ...
    if (locationRecord) {
        ...
        return {
            success: false,
            message: "The location key \"" + requestBody.locationKey + "\"" +
